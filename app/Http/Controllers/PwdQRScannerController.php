...
class PwdQRScannerController extends Controller
{
    public function index(Request $request)
    {
        return view('pages.pwd_qrcode_scanner', [ 
    ...
    public function scan($id) 
    {
        ...
        // Split the QR code value (e.g. "PWD-001") into two parts: PWD as type and 001 as id
        // $type = record type PWD
        ...
        if ($type === 'PWD') {
            $record = PwdRecord::with('pwdRequirement')->find($id);
