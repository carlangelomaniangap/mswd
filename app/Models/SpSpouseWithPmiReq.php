...
class SpSpouseWithPmiReq extends Model
{
    protected $fillable = [
        ...
        'marriage_cert_or_affidavit_of_cohabitation_expires_at',
        'marriage_cert_or_affidavit_of_cohabitation_updated_at',
        'med_record_med_abstract_or_cert_of_confinement',
        'med_record_med_abstract_or_cert_of_confinement_expires_at',
        'med_record_med_abstract_or_cert_of_confinement_updated_at',
        'a4_solo_parent_not_cohabiting',
        'a4_solo_parent_not_cohabiting_expires_at',
        'a4_solo_parent_not_cohabiting_updated_at',
