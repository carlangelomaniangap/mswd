...
class SpSpouseDeprivedLibertyReq extends Model
{
    protected $fillable = [
        ...
        'certificate_of_detention_expires_at',
        'certificate_of_detention_updated_at',
        'a3_solo_parent_not_cohabiting',
        'a3_solo_parent_not_cohabiting_expires_at',
        'a3_solo_parent_not_cohabiting_updated_at',
