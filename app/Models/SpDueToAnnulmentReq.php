...
class SpDueToAnnulmentReq extends Model
{
    protected $fillable = [
        ...
        'marriage_certificate_nullity_expires_at',
        'marriage_certificate_nullity_updated_at',
        'judicial_decree_of_nullity',
        'judicial_decree_of_nullity_expires_at',
        'judicial_decree_of_nullity_updated_at',
        'a6_solo_parent_not_cohabiting',
        'a6_solo_parent_not_cohabiting_expires_at',
        'a6_solo_parent_not_cohabiting_updated_at',
