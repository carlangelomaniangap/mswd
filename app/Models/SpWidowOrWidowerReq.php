...
class SpWidowOrWidowerReq extends Model
{
    protected $fillable = [
        ...
        'death_certificate_of_the_spouse_expires_at',
        'death_certificate_of_the_spouse_updated_at',
        'a2_solo_parent_not_cohabiting',
        'a2_solo_parent_not_cohabiting_expires_at',
        'a2_solo_parent_not_cohabiting_updated_at',
