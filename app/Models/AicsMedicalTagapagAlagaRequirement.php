...
class AicsMedicalTagapagAlagaRequirement extends Model
{
    protected $fillable = [
        'aics_record_id',
        'personal_letter',
        ...
        'brgy_certificate_of_proof_ng_pangangalaga_expires_at',
        'brgy_certificate_of_proof_ng_pangangalaga_updated_at',
