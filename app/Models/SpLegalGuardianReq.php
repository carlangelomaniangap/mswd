...
class SpLegalGuardianReq extends Model
{
    protected $fillable = [
        ...
        'proof_of_guardianship_expires_at',
        'proof_of_guardianship_updated_at',
        'd_solo_parent_not_cohabiting',
        'd_solo_parent_not_cohabiting_expires_at',
        'd_solo_parent_not_cohabiting_updated_at',
