...
class SpUnmarriedPersonReq extends Model
{
    protected $fillable = [
        ...
        'certificate_of_no_marriage_expires_at',
        'certificate_of_no_marriage_updated_at',
        'c_solo_parent_not_cohabiting',
        'c_solo_parent_not_cohabiting_expires_at',
        'c_solo_parent_not_cohabiting_updated_at',
