...
return new class extends Migration
{
    ...
    {
        Schema::create('sp_due_to_annulment_reqs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('marriage_certificate_nullity', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('marriage_certificate_nullity_expires_at')->nullable();
            $table->date('marriage_certificate_nullity_updated_at')->nullable();
            $table->enum('judicial_decree_of_nullity', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('judicial_decree_of_nullity_expires_at')->nullable();
            $table->date('judicial_decree_of_nullity_updated_at')->nullable();
            $table->enum('a6_solo_parent_not_cohabiting', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('a6_solo_parent_not_cohabiting_expires_at')->nullable();
            $table->date('a6_solo_parent_not_cohabiting_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('sp_due_to_annulment_reqs');
    }
};
