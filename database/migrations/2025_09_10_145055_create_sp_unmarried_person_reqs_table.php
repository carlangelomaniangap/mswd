...
return new class extends Migration
{
    ...
    {
        Schema::create('sp_unmarried_person_reqs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('certificate_of_no_marriage', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('certificate_of_no_marriage_expires_at')->nullable();
            $table->date('certificate_of_no_marriage_updated_at')->nullable();
            $table->enum('c_solo_parent_not_cohabiting', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('c_solo_parent_not_cohabiting_expires_at')->nullable();
            $table->date('c_solo_parent_not_cohabiting_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('sp_unmarried_person_reqs');
    }
};
