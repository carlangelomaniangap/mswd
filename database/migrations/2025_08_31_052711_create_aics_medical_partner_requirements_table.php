...
return new class extends Migration
{
    ...
    {
        Schema::create('aics_medical_partner_requirements', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('brgy_cert_of_indigency_ng_pasyente_at_magulang', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('brgy_cert_of_indigency_ng_pasyente_at_magulang_expires_at')->nullable();
            $table->date('brgy_cert_of_indigency_ng_pasyente_at_magulang_updated_at')->nullable();
            ...
            $table->enum('marriage_cert_or_brgy_cert_of_cohabitation', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('marriage_cert_or_brgy_cert_of_cohabitation_expires_at')->nullable();
            $table->date('marriage_cert_or_brgy_cert_of_cohabitation_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('aics_medical_partner_requirements');
    }
};
