...
return new class extends Migration
{
    ...
    {
        Schema::create('aics_medical_kapatid_requirements', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('birth_certificate_of_pasyente_at_client', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('birth_certificate_of_pasyente_at_client_expires_at')->nullable();
            $table->date('birth_certificate_of_pasyente_at_client_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('aics_medical_kapatid_requirements');
    }
};
