...
return new class extends Migration
{
    ...
    {
        Schema::create('aics_medical_magulang_requirements', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('birth_certificate_of_patient', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('birth_certificate_of_patient_expires_at')->nullable();
            $table->date('birth_certificate_of_patient_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('aics_medical_magulang_requirements');
    }
};
