...
return new class extends Migration
{
    ...
    {
        Schema::create('sp_due_to_legal_separation_reqs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('marriage_certificate', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('marriage_certificate_expires_at')->nullable();
            $table->date('marriage_certificate_updated_at')->nullable();
            $table->enum('judicial_decree_of_legal_separation', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('judicial_decree_of_legal_separation_expires_at')->nullable();
            $table->date('judicial_decree_of_legal_separation_updated_at')->nullable();
            $table->enum('a5_solo_parent_not_cohabiting', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('a5_solo_parent_not_cohabiting_expires_at')->nullable();
            $table->date('a5_solo_parent_not_cohabiting_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('sp_due_to_legal_separation_reqs');
    }
};
