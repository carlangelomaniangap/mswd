...
return new class extends Migration
{
    ...
    {
        Schema::create('sp_relative_consanguinity_reqs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('death_cert_cert_incapacity', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('death_cert_cert_incapacity_expires_at')->nullable();
            $table->date('death_cert_cert_incapacity_updated_at')->nullable();
            $table->enum('proof_of_relationship', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('proof_of_relationship_expires_at')->nullable();
            $table->date('proof_of_relationship_updated_at')->nullable();
            $table->enum('e_solo_parent_not_cohabiting', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('e_solo_parent_not_cohabiting_expires_at')->nullable();
            $table->date('e_solo_parent_not_cohabiting_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('sp_relative_consanguinity_reqs');
    }
};
