...
return new class extends Migration
{
    ...
    {
        Schema::create('sp_spouse_deprived_liberty_reqs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('certificate_of_detention', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('certificate_of_detention_expires_at')->nullable();
            $table->date('certificate_of_detention_updated_at')->nullable();
            $table->enum('a3_solo_parent_not_cohabiting', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('a3_solo_parent_not_cohabiting_expires_at')->nullable();
            $table->date('a3_solo_parent_not_cohabiting_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('sp_spouse_deprived_liberty_reqs');
    }
};
