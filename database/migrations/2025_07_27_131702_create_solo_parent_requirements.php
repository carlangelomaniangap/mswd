...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('solo_parent_requirements', function (Blueprint $table) {
            ...
            $table->date('solo_parent_id_application_form_expires_at')->nullable();
            $table->date('solo_parent_id_application_form_updated_at')->nullable();
            $table->enum('affidavit_of_solo_parent', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('affidavit_of_solo_parent_expires_at')->nullable();
            $table->date('affidavit_of_solo_parent_updated_at')->nullable();
