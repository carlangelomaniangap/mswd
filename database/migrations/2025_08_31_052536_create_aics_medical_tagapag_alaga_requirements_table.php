...
return new class extends Migration
{
    ...
    {
        Schema::create('aics_medical_tagapag_alaga_requirements', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('brgy_certificate_of_proof_ng_pangangalaga', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('brgy_certificate_of_proof_ng_pangangalaga_expires_at')->nullable();
            $table->date('brgy_certificate_of_proof_ng_pangangalaga_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('aics_medical_tagapag_alaga_requirements');
    }
};
