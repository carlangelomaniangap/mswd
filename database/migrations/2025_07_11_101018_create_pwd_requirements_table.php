...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('pwd_requirements', function (Blueprint $table) {
            ...
            $table->datetime('medical_certificate_expires_at')->nullable();
            $table->datetime('medical_certificate_updated_at')->nullable();
            $table->enum('barangay_certificate', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->datetime('barangay_certificate_expires_at')->nullable();
            $table->datetime('barangay_certificate_updated_at')->nullable();
