...
return new class extends Migration
{
    ...
    {
        Schema::create('sp_widow_or_widower_reqs', function (Blueprint $table) {
            $table->id();
            ...
            $table->enum('death_certificate_of_the_spouse', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('death_certificate_of_the_spouse_expires_at')->nullable();
            $table->date('death_certificate_of_the_spouse_updated_at')->nullable();
            $table->enum('a2_solo_parent_not_cohabiting', ['Complete', 'Incomplete', 'Renewal', 'Denied'])->default('Incomplete');
            $table->date('a2_solo_parent_not_cohabiting_expires_at')->nullable();
            $table->date('a2_solo_parent_not_cohabiting_updated_at')->nullable();
    ...
    {
        Schema::dropIfExists('sp_widow_or_widower_reqs');
    }
};
