...
@php
    ...
    switch ($variant) {
        ...
        break;
        case 'secondary':
            $variantClasses = 'bg-white text-gray-500 hover:bg-gray-50 hover:text-gray-400 focus:ring-blue-500 dark:text-gray-400 dark:bg-dark-eval-1 dark:hover:bg-dark-eval-2 dark:hover:text-gray-200';
        break;
        case 'success':
