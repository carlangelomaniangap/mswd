...
<script>
    $(document).ready(function () {
        $('#addBeneficiary').on('submit', function (e) {
            ...
            $.ajax({
                url: `/admin/senior_citizen/store`,
                method: 'POST',
                data: formData,
                contentType: false,
                processData: false,
...
<script>
    $(document).on('click', '[data-id]', function () {
        ...
        $('#family_member').DataTable({
            ...
            ajax: {
                url: `/admin/senior_citizen/${id}/family-member`,
                dataSrc: 'data'
            },
            ordering: false,
            columns: [
...
<script>
    $(document).ready(function () {
        $('#addFamilyMemberForm').on('submit', function (e) {
            ...
            $.ajax({
                url: `/admin/senior_citizen/store/family-member`,
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
...
<script>
    $(document).ready(function () {
        ...
        $('#Requirements').on('submit', function (e) {
            ...
            $.ajax({
                url: `/admin/senior_citizen/${id}/update/requirements`,
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
