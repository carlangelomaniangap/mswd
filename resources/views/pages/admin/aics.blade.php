                        ...
                        <div id="aics_info" class="grid grid-cols-2 gap-4 p-6">
                            <div class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <span id="aics_type_of_disability" class="font-semibold"></span>
                                </div>
                                <div class="flex items-center justify-start gap-6">
                                    <div>
...
<script>
    $(document).on('click', '[data-id]', function () {
        ...
        $('#aics_id, #aics_first_name, #aics_last_name, #aics_address, #aics_type_of_disability, #aics_birth, #aics_sex, #aics_cellphone_number, #aics_created_at').text('');
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#aics_type_of_disability').text(data.type_of_disability);
        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                $('#family_member').DataTable({
                    ...
                    ajax: {
                        url: `/admin/aics/${id}/family-member`,
                        dataSrc: 'data'
                    },
                    ordering: false,
                    columns: [
