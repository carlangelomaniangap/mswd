...
<head>
    ...
    <title>Senior Citizen Record Data</title>
        ...
        <div class="min-h-screen text-gray-900 bg-gray-100 dark:bg-dark-eval-0 dark:text-gray-200">
            ...
            >
                <div class="p-4 flex items-center justify-between">
                    <h1 class="font-bold text-2xl">Senior Citizen Record Data</h1>
                    ...
                    <div class="bg-white dark:bg-dark-eval-1 shadow rounded p-4">
                        ...
                        <div class="grid grid-cols-3 grid-rows-1 gap-4">
                            <div class="flex flex-col items-center gap-4">
                                ...
                                <div><strong>Senior ID:</strong> <span id="senior_id">Loading...</span></div>
                            </div>
...
<script>
    $(document).ready(function() {
        ...
        function fetchRecord(id) {
            $.ajax({
                url: `/senior_citizen/record/data/scan/${id}`,
                type: 'GET',
                success: function(res) {
                    if(res.success){
                        ...
                        $('#senior_id').text(`SC-${String(data.id).padStart(3, '0')}`);
                        ...
                        const fields = [
                            ...
                            { key: 'barangay_certificate', label: 'Barangay Certificate', expiredANDupdatedKey: 'barangay_certificate' },
                        ];
